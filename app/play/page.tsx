      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-2 lg:grid-cols-4">
        {GAMES.map(g => (
          <Link key={g.key} href={`/play?game=${g.key}`}
            className={`glass rounded-xl p-4 sm:p-6 group hover:scale-[1.02] transition-all text-center ${(g as any).highlight ? 'ring-1 ring-primary/40 bg-primary/5 hover:bg-primary/10' : 'hover:bg-white/5'}`}>
            ...
            {(g as any).highlight && <span className="text-[8px] sm:text-[9px] px-1 sm:px-1.5 py-0.5 rounded bg-red-500/20 text-red-300 font-bold">AGENTS ONLY</span>}
