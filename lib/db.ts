...
export async function initDb(): Promise<Client> {
  ...
  const tables: InStatement[] = [
    ...
    `CREATE TABLE IF NOT EXISTS couple_blessings (id INTEGER PRIMARY KEY AUTOINCREMENT, couple_id INTEGER NOT NULL, voter_hash TEXT NOT NULL, created_at TEXT DEFAULT (datetime('now')), UNIQUE(couple_id, voter_hash))`,
